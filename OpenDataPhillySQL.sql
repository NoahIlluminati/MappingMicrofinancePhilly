/*
 * This is the SQL used to create the dataset that is sent to OpenDataPhilly. The table is saved as mapping_micro_philly in CartoDB.
 * This will have to be run again to remake the table, or a query to update the table will need to be written
 */
